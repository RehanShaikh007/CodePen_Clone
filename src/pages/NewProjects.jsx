...
const NewProjects = () => {
  ...
  return (
    <>
      <div className="flex-col flex items-start justify-start h-full w-full text-white">
                ...
                <div className="bg-[#282c34] p-4 rounded-lg shadow">
                  <div className="flex items-center justify-between">
                    <div className="bg-secondary px-4 py-2 border-t-4 flex items-center justify-center gap-3 border-t-gray-500">
                      ...
                      <p className="text-primaryText font-semibold text-red-500">HTML</p>
                    </div>
                ...
                <div className="bg-[#282c34] p-4 rounded-lg shadow">
                  <div className="flex items-center justify-between">
                    <div className="bg-secondary px-4 py-2 border-t-4 flex items-center justify-center gap-3 border-t-gray-500">
                      ...
                      <p className="text-primaryText font-semibold text-blue-500">CSS</p>
                    </div>
                    <div className="cursor-pointer flex items-center justify-center gap-5 px-4">
                      <FcSettings className="text-xl" />
                      <FaChevronDown className="text-xl text-primaryText" />
                ...
                <div className="bg-[#282c34] p-4 rounded-lg shadow">
                  <div className="flex items-center justify-between">
                    <div className="bg-secondary px-4 py-2 border-t-4 flex items-center justify-center gap-3 border-t-gray-500">
                      ...
                      <p className="text-primaryText font-semibold text-yellow-500">
                        JavaScript
                      </p>
                    </div>
                    <div className="cursor-pointer flex items-center justify-center gap-5 px-4">
