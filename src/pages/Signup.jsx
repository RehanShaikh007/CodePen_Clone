  ...
  return (
    <div className="w-full py-6">
      ...
      <div  className="w-full flex flex-col items-center justify-center py-8">
        <p className="py-12 text-2xl text-primaryText text-gray-100">Join with Us!</p>
        <div id="join-cnt" className="px-8 w-full md:w-auto py-4 rounded-xl bg-secondary shadow-md flex flex-col items-center justify-center gap-8">
          <Input
            label="Email"
            placeholder="Email"
            isPass={false}
          ...
          <p className="text-md text-primaryText flex items-center justify-center gap-3 text-gray-400">
          ...
          >
            ...
            <p className="text-xl text  text-white">Sign in with Google</p>
          </motion.div>
          <div className="flex items-center justify-center gap-12">
            <div className="h-[1px] bg-[rgba(256,256,256,0.2)] rounded-md w-24"></div>
            <p className="text-sm text-[rgba(256,256,256,0.2)]">Or</p>
